...
export default {
  ...
  methods: {
    ...
    // 感知子树节点被点击
    treenodeclick(data, node, compo) {
      console.log("attrgroup-treenodeclick:   ", data, node, compo);
      console.log("attrgroup-treenodeclick-nodecatId:   ", node.data.catId);
      console.log("attrgroup-treenodeclick-datacatId:   ", data.catId);
      if (node.level == 3) {
